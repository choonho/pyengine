...
ERROR_INFO = [
...

	{
		...
		"status_code" : 500,
		"message" : "DB query failed (%reason)",
		"args" : ["reason"]
	},
...

	{
		...
		"status_code" : 400,
		"message" : "Not found value. (%key = %value)",
		"args" : ['key', 'value']
	},
    ...
    # Custom Error Info
	{
		...
		"status_code" : 400,
		"message" : "ID format id is invalid.",
		"args" : []
	},

	{
		...
		"status_code" : 400,
		"message" : "ID format password is invalid.",
		"args" : []
	},
